// Stable free-only pool (verified working, no paid/removed models)
const FREE_MODELS = [
  ...
  "microsoft/phi-3-mini-128k-instruct:free","microsoft/phi-4:free",
  "deepseek/deepseek-chat-v3-0324:free","deepseek/deepseek-prover-v2:free",
  ...
  "rekaai/reka-flash-3:free","moonshotai/kimi-vl-a3b-thinking:free"
];
module.exports = { FREE_MODELS };
